-- Replace Explosive Biters small-atomic-explosion with a lightweight nuke-style blast.
...
log("[explosive-biter-optimizations] Patched small-atomic-explosion (outer="
  .. outer_damage .. " / " .. radius .. ", inner=" .. inner_damage .. " / " .. inner_radius .. ").")
